      ...
      <header id="header" className="d-flex flex-column justify-content-center">
        <nav id="navbar" className="navbar nav-menu">
          <ul>
            ...
            <li><a href="/add" className="nav-link scrollto"><img src="https://api.iconify.design/ic:baseline-woman.svg?color=%23888888" alt="today"  className="h-6 w-6" /> <span>Add Task</span></a></li>
