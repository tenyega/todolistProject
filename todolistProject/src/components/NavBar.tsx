      ...
      <header id="header" className="d-flex flex-column justify-content-center">
        <nav id="navbar" className="navbar nav-menu">
          <ul>
            ...
            <li><a href="#today" className="nav-link scrollto"><img src="https://api.iconify.design/ic:baseline-woman.svg?color=%23888888" alt="today"  className="h-6 w-6" /> <span>Today's Task</span></a></li>
            <li><a href="#important" className="nav-link scrollto"><img src="https://api.iconify.design/material-symbols:file-copy-outline.svg?color=%23888888" alt="important" className="h-6 w-6"/><span>Important</span></a></li>
